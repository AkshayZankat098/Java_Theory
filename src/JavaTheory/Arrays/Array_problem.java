...
//ShortingInt ::    
    public static void ShortingInt1() {
        ...
        System.out.println("Before Short" + Arrays.toString(a)); //JavaTheory.Arrays.toString(a) : method is used to return a string representation, It converts the array into a readable format that can be easily displayed or printed
        Arrays.sort(a);
...
//JavaTheory.Arrays Problem1 : Reverse the arrays
...
//JavaTheory.Arrays Problem2 : Find the smallest & biggest number in arrays
...
//JavaTheory.Arrays Problem3 : Check if the given array is in non decreasing order
...
//JavaTheory.Arrays Problem4 : Find the total number of student present in class or sum 2dArrays
...
//JavaTheory.Arrays problem5 : Find the center of the given matrix
...
//JavaTheory.Arrays problem6 : Determine the matrix T sum
...
//JavaTheory.Arrays problem7 : Given a number n. Add all the numbers from 1 to n.
...
//JavaTheory.Arrays problem8 : You are given two numbers as input. You have to return the largest of the two numbers as output.
...
//JavaTheory.Arrays problem9 : Classify even and odd number.
...
//JavaTheory.Arrays problem10 : Find the reminder of the number.
